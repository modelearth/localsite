...
function loadMap1(show, dp) { // Also called by map-filters.js
  ...
  */
  ...
  if (dp && dp.dataset) { // Parameters set in page or layer json
    ...
    dp1.listInfo = "Select a category to the left to filter results. View&nbsp;<a href='https://www.georgia.org/sites/default/files/2020-11/ga_suppliers_list_11-25-2020.pdf' target='_parent'>PDF&nbsp;version</a>&nbsp;of&nbsp;the&nbsp;complete&nbsp;list.";
    dp1.dataset = "https://map.georgia.org/display/products/suppliers/us_ga_suppliers_ppe_2020_11_25.csv";
