...
function loadMap1(show, dp) { // Also called by map-filters.js
  ...
  */
  ...
  if (dp && dp.dataset) { // Parameters set in page or layer json
    ...
    dp1.listInfo = "Currently limited to seniors 65 and older. Make your appointment in advance. <a href='https://www.vaccinatega.com/vaccination-sites/providers-in-georgia'>Check major providers</a> and <a href='neighborhood/vaccines/'>view availability and contribute updates</a>.";
