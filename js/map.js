...
function loadMap1(dp) { // Also called by map-filters.js
  ...
  */
  ...
  if (dp && dp[0]) { // Parameters set in page or layer json
    ...
    dp1.listInfo = "Select a category to the left to filter results. View&nbsp;<a href='https://www.georgia.org/sites/default/files/2020-09/ga_suppliers_list_9-2-2020.pdf' target='_parent'>PDF&nbsp;version</a>&nbsp;of&nbsp;the&nbsp;complete&nbsp;list.";
