...
function loadMarkdown(pagePath, divID, target) {
  ...
  d3.text(pagePath).then(function(data) {
    ...
    var pencil = "<div class='markdownEye' style='position:absolute;font-size:28px;right:0px;text-decoration:none;opacity:.7'><a href='" + pagePath + "' style='color:#555'>…</a></div>";
    ...
    if (thediv) {
      ...
      console.log("ALERT: " + divID + " not available in page for to showdown to insert text.")
    }
