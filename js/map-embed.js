...
strVar += "                -->";
strVar += "                <input readonly id=\"appMenu\" class=\"filterClick mobileWide textInput\" placeholder=\"Bioeconomy\" type=\"text\" autocomplete=\"off\" style=\"width: 200px; margin-top: 0px;\" \/>";
strVar += "            <\/div>";
strVar += "        <\/div>";
strVar += "      <\/div>";
strVar += "";
...
strVar += "";
strVar += "      <div style=\"overflow:visible; display:none\" class=\"filterField searchElements local mock-up earth\">";
strVar += "          <div class=\"filterLabel\">";
strVar += "            <div class=\"filterLabelMain\">";
strVar += "              Where";
strVar += "              <\/div>";
...
strVar += "";
strVar += "    ";
strVar += "      <div class=\"hideMobile\" style=\"float:left; clear:both\">";
...
strVar += "";
strVar += "      <\/div>";
strVar += "      <div id=\"locationFilterHolder\" style=\"overflow:auto; padding-top:20px\">";
strVar += "";
strVar += "            <div class=\"hideAdvanced close-X\" style=\"float:right; margin-top:-20px\">&#10005;";
strVar += "            <\/div>";
strVar += "";
strVar += "            <div class=\"input-output\" style=\"float:left\">";
strVar += "              <b>State<\/b><br>";
...
strVar += "                <option value='Central' lat='33.0362' lon='-85.0322' geo='US13023,US13043,US13091,US13109,US13167,US13175,US13209,US13267,US13271,US13279,US13283,US13309,US13315,US13107,US13235'>Central<\/option>";
...
strVar += "        <div id=\"app\">";
strVar += "";
strVar += "          <div class=\"place_details\" style=\"float:left;margin-bottom:15px\">";
strVar += "          ";
...
strVar += "        <!-- \/GOOGLE ADDRESS AUTOCOMPLETE -->";
strVar += "";
strVar += "        <div style=\"overflow:auto; border:0px solid #ccc;\" class=\"geoListHolder height100\">";
strVar += "";
...
strVar += "    ";
strVar += "    <div style=\"float:left;displayX:none\" class=\"currentCities\">";
strVar += "";
