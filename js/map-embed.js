...
strVar += "      <\/div>";
strVar += "";
strVar += "      <div style=\"overflow:visible; display:none\" class=\"filterField searchElements mock-up earth neighborhood\">";
strVar += "        <div class=\"filterLabel\">";
strVar += "          <div class=\"filterLabelMain\">";
strVar += "            Where";
strVar += "            <\/div>";
...
strVar += "          <\/div>";
strVar += "          <div class=\"filterSelected\" style=\"padding-right:28px\">County<\/div><!-- Entire State -->";
strVar += "        <\/div>";
strVar += "      <\/div>";
strVar += "";
...
strVar += "";
strVar += "                  <div style=\"display:table; width:100%\">";
strVar += "                    <div style=\"min-height:30px; padding:10px; display: table-cell; vertical-align: middle\">";
strVar += "                      Choose one or more counties above.";
strVar += "                    <\/div>";
strVar += "                    <div style=\"display: table-cell; padding:7px;\">";
strVar += "                      <div class=\"detailbutton hideAdvanced\" style=\"float:right\">Done<\/div>";
strVar += "                    <\/div>";
strVar += "                  <\/div>";
strVar += "";
strVar += "                <\/div>";
